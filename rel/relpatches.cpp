    ...
    namespace stage_author_names {
        ...
        void init_main_loop() {
            ...
            if (author_file_buf == nullptr) {
                ...
                MOD_ASSERT_MSG(author_file_length != 0, "Author name file (stgname/authors.str) failed to load from disc");
                ...
                author_file_buf = static_cast<char*>(heap::alloc_from_heap(author_file_length));
                author_file_length = mkb::read_entire_file_using_dvdread_prio_async(&author_file_info, author_file_buf, author_file_length, 0);
                ...
                do {
                    ...
                    MOD_ASSERT_MSG(name_end != nullptr, "Author name author_file_buf ended unexpectedly, please ensure there are 421 lines in the author_file_buf");
                    MOD_ASSERT_MSG((name_end-author_file_buf) < 128, "Author name for a stage is greater than the limit of 127 characters");
